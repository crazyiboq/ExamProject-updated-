...
{
    /// <inheritdoc />
    public partial class FixTestIdForeignKey : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionBoxes_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GlobalLeaderboards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GlobalLeaderboards_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leaderboards_Tests_TestId",
                        column: x => x.TestId,
                        principalTable: "Tests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTestHistories_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Birthday", "Password", "RoleId", "Username" },
                values: new object[] { 1, new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin123", 1, "admin" });

            migrationBuilder.CreateIndex(
                name: "IX_GlobalLeaderboards_UserId",
                table: "GlobalLeaderboards",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionBoxes_QuestionId",
                table: "QuestionBoxes",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_Leaderboards_TestId",
                table: "Leaderboards",
                column: "TestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTestHistories_UserId_TestId",
                table: "UserTestHistories",
